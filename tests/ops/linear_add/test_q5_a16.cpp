...
int q5_a16_conformance() {
    ...
    constexpr std::array<std::int32_t, 12> kK6144RouteInteriors{
        1, 8, 24, 40, 96, 256, 1023, 1024, 1025, 1152, 2048, 2049};
    ...
    constexpr std::array<std::int32_t, 12> kK17408RouteInteriors{
        1, 8, 24, 40, 96, 256, 1023, 1024, 1025, 1152, 2048, 2049};
    failures += ninfer::test::linear_add::run_shape(
        "Q5_A16 LinearAdd", WeightFormat::Q5G64F16S,
